    ...
    <MainLayout>
      <div className="space-y-4">
        <section className="rounded-3xl border border-slate-200 bg-white p-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 text-xs rounded-lg bg-lumiva-accent text-slate-950 font-semibold border border-lumiva-accent shadow-sm hover:bg-lumiva-accent-soft transition-colors"
              >
          ...
          <div className="mt-4 border-b border-slate-200">
            <div className="flex flex-wrap gap-4 text-[12px] text-slate-500">
              {(['automations', 'history', 'integrations', 'usage'] as const).map((tab) => (
                <button
                  key={tab}
                  type="button"
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-4">
          <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-[12px] text-slate-600 flex items-center justify-between gap-3">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-4 space-y-4">
          ...
          {!loading && !error && activeTab !== 'automations' && (
            <div className="rounded-2xl border border-slate-200 bg-white px-4 py-8 text-center text-sm text-slate-500">
              {t('crm.automations.panel.comingSoon')}
            </div>
          )}

          {!loading && !error && activeTab === 'automations' && filtered.length === 0 && (
            <div className="rounded-2xl border border-slate-200 bg-white px-4 py-8 text-center text-sm text-slate-500">
