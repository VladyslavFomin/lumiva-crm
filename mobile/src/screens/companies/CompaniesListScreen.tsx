      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('Companies', { screen: 'CompanyDetail', params: { id: item.id } })}
          >
            <View style={styles.cardHeader}>
              ...
              <View style={styles.cardContent}>
                ...
                {item.industry && <Text style={[styles.industry, { color: colors.textSecondary }]}>{item.industry}</Text>}
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>Нет компаний</Text>
          </View>
        }
      />
    </View>
...
const styles = StyleSheet.create({
  ...
  industry: { fontSize: 14, marginBottom: 2 },
